...
class ChattingUserReportActivity : BaseActivity<FragmentChattingUserReportBinding>(FragmentChattingUserReportBinding::inflate) {

    private var reportedMemberId = 0

    override fun initAfterBinding() {
        reportedMemberId = intent.getStringExtra("memberId").toString().toInt()
    ...
    private fun initClickListener() {
        ...
        // 뒤로가기 버튼
        binding.reportChatBackBtn.setOnClickListener {
            finish()
        }
    }
